...
# Team roster now lives in config.team; re-exported here to preserve the public
# API used by core.auth and other modules (from core.loader import FARMERS_EMAILS…).
from config.team import (  # noqa: E402  (re-export for backward compatibility)
    EXCLUDED_EMAILS,
    FARMER_NAMES,
    FARMERS_EMAILS,
    SLACK_IDS,
